...
fn main() {
    ...
    println!("  0.5 -> {:.6} (should be around 0.6-0.7)", easing.apply(0.5));
    ...
    println!("\n📈 Maximum overshoot:");
    println!("  Progress: {:.2}, Value: {:.6} (overshoot: {:.3})", 
             max_progress, max_value, max_value - 1.0);
    ...
    for i in 0..=10 {
        ...
        println!("  Progress {:.1}: eased={:.3}, window_x={}", progress, eased, current_x);
    }
}