...
impl EasingFunction {
    ...
    pub fn from_name(name: &str) -> Self {
        match name.to_lowercase().as_str() {
            ...
            "spring" => EasingFunction::Spring { stiffness: 300.0, damping: 30.0 },
            _ => {
        ...
        match self {
            ...
            EasingFunction::EaseInOutElastic => {
                if t == 0.0 {
                    ...
                    -(2.0_f32.powf(20.0 * t - 10.0) * ((20.0 * t - 11.125) * 2.0 * PI / 4.5).sin()) / 2.0
                } else {
                    2.0_f32.powf(-20.0 * t + 10.0) * ((20.0 * t - 11.125) * 2.0 * PI / 4.5).sin() / 2.0 + 1.0
                }
            }
